...
| Frames | multi-frame, skippable frames, hard output bound, truncation, trailing garbage, empty frame |
...
| zstd frames: levels 1–22, hard bound with and without content size, forged content size, concatenated and skippable frames, corruption, zstd CLI interoperability in both directions | `test_frames.py` |
